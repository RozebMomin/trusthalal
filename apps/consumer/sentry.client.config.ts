...
// "deno:", or Node "node:" module paths — often surfacing as unhandled
// rejections from fetch/stream shims (e.g. reading getReader on a body the
// runtime never streamed). Not real users; drop them.
