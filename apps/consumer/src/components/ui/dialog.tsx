 ...
 * needs to diverge consumer-side later, we have a self-contained file
 * to edit.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile-friendly defaults: leave a 1rem gutter on each side
        // (so the dialog doesn't kiss the screen edges on a phone),
        // cap height to 90dvh and scroll inside if content overflows.
        // Padding shrinks on mobile (p-4 → p-6 from sm+) so a phone
        // viewport doesn't burn 24px on each side just for chrome.
