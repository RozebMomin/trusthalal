...
const CONTACT_EMAIL = "hello@trusthalal.org";
...
// ---------------------------------------------------------------------------
// Header — brand mark, section nav (hidden on small screens), and a
// persistent primary CTA so the top-right action is always "go find
// halal food".
// ---------------------------------------------------------------------------
function Header() {
  return (
    <header className="mb-16 flex items-center justify-between gap-4 sm:mb-24">
      ...
      <div className="flex items-center gap-5">
        ...
        >
          ...
          <a href={ETHICS_URL} className="transition hover:text-stone">
            Ethics
          </a>
          <a
...
// ---------------------------------------------------------------------------
// Footer — structured columns on the cream canvas.
// ---------------------------------------------------------------------------
function Footer() {
  return (
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="mb-10 grid gap-10 sm:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <FooterColumn
            title="Company"
            links={[
              { label: "AI ethics", href: ETHICS_URL },
              {
                label: CONTACT_EMAIL,
                href: `mailto:${CONTACT_EMAIL}`,
              },
