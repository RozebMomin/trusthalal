...
def search_diagnostics(
    ...
    beef_zabihah: list[ZabihahStatus] | None = Query(default=None),
    lamb_zabihah: list[ZabihahStatus] | None = Query(default=None),
    goat_zabihah: list[ZabihahStatus] | None = Query(default=None),
    ...
    diagnostics = diagnose_empty_search(
        ...
        halal_filters=HalalSearchFilters(
            ...
            beef_zabihah=tuple(beef_zabihah or ()),
            lamb_zabihah=tuple(lamb_zabihah or ()),
            goat_zabihah=tuple(goat_zabihah or ()),
