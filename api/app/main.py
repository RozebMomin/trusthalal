...
# verifier-self surface for filing site visits + uploading evidence.
...
from app.modules.admin.certifiers.router import router as admin_certifiers_router  # noqa: E402
...
app.include_router(admin_certifiers_router)
